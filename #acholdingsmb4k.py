...
class Player:
    ...
    def draw(self, surface, camera_x):
        ...
        y = self.rect.y
        # Mario body
        pygame.draw.rect(surface, MARIO_RED, (x, y, TILE_SIZE, TILE_SIZE))
        # Overalls (blue rectangle on lower half)
        pygame.draw.rect(surface, MARIO_BLUE, (x, y + TILE_SIZE//2, TILE_SIZE, TILE_SIZE//2))
        # Hat (red)
        pygame.draw.rect(surface, MARIO_RED, (x + 4, y - 4, TILE_SIZE - 8, 8))
